...
import { addArtefact } from "../services/backend-service";
...
const UploadForm = () => {
    ...
    const [threeDItem, setThreeDItem] = useState<File | null>(null);
    const [submitSuccess, setSubmitSuccess] = useState(false);
  
    const handleChangeState = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    ...
    const handleThreeDItemChange = (e: React.ChangeEvent<HTMLInputElement>) => {
      const file = e.target.files?.[0] || null;
      setThreeDItem(file);
    };
    ...
    const handleSubmit = async (e: React.FormEvent) => {
      ...
      if (threeDItem) {
        formData.append('threeDItem', threeDItem);
      }
